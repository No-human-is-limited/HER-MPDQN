...
class PDQNAgent(Agent):
    ...
    def __init__(self,
        ...
        # old params and donnot need later
        self.writer = writer
        self._forward = 0
    ...
    def optimize_td_loss(self):
        ...
        states, actions, rewards, next_states, terminals, goals, _, _ = \
            self.replay_memory_true.sample(random_size, random_machine=self.np_random)
